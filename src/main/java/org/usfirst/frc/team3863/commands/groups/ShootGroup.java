...
import org.usfirst.frc.team3863.commands.endeffector.CenterPistonCommand;
...
public class ShootGroup extends CommandGroup {
    ...
    public ShootGroup() {
        ...
        addSequential(new CenterPistonCommand(true));
        ...
        addSequential(new CenterPistonCommand(false));
