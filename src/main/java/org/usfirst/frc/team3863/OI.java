...
public class OI {
    ...
    public JoystickButton
            leftJoyButton1 = new JoystickButton(leftJoystick, 1),
            ...
            leftJoyTrigger = new JoystickButton(leftJoystick, Joystick.ButtonType.kTrigger.value);


    public Joystick rightJoystick = new Joystick(RobotMap.RIGHT_JOYSTICK);
    public JoystickButton
            rightJoyButton1 = new JoystickButton(rightJoystick, 1),
            ...
            rightJoyTrigger = new JoystickButton(rightJoystick, Joystick.ButtonType.kTrigger.value);
